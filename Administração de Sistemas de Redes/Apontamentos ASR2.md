...
**Para verificar estes dois ficheiros basta utilizar o comando pwck , caso os ficheiros estejam desincronizados podesse utilizar pwconv para compor os ficheiros** -> Este vai adicionar 